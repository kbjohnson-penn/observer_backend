...
from accounts.models import Profile, Tier, Organization, AgreementType, Agreement, UserAgreement
...
class AgreementAPITest(BaseTestCase):
    ...
    def test_get_user_agreements_authenticated(self):
        ...
        self.assertIn(agreement_data['agreement_title'], ['PhysioNet Data Use Agreement', 'Research Ethics Code'])
...
class AgreementModelTest(TestCase):
    ...
    def setUp(self):
        self.agreement_type = baker.make(
            AgreementType, 
            name="Test Type",
            _using='accounts'
        )
