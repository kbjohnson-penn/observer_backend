...
class EmailVerificationTokenModelTest(TestCase):
    ...
    def test_token_creation(self):
        ...
        token = EmailVerificationToken.objects.db_manager('accounts').create(
            user=self.user
        )
    ...
    def test_token_uniqueness(self):
        ...
        token1 = EmailVerificationToken.objects.db_manager('accounts').create(
            user=self.user
        )
        ...
        token2 = EmailVerificationToken.objects.db_manager('accounts').create(
            user=user2
        )
