...
class Profile(models.Model):
    ...
    address_1 = models.CharField(
        max_length=100, blank=True, null=True, validators=[validate_address]
    )
    address_2 = models.CharField(
        max_length=100, blank=True, null=True, validators=[validate_address]
    )
    city = models.CharField(max_length=100, blank=True, null=True, validators=[validate_field])
    state = models.CharField(
        max_length=100,
        blank=True,
        null=True,
        choices=GENERIC_STATE_CHOICES,
    ...
    zip_code = models.CharField(max_length=5, blank=True, null=True, validators=[validate_numeric])
