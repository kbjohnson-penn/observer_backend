...
class UserAgreementViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        ...
        return UserAgreement.objects.using('accounts').filter(
            user=self.request.user,
            is_active=True
        ).select_related('agreement', 'agreement__agreement_type').order_by('-signed_at')
    ...
    def grouped(self, request):
        ...
        for user_agreement in user_agreements:
            ...
            agreement_data = {
                ...
                'project': user_agreement.agreement.project_description or user_agreement.agreement.project_name,
