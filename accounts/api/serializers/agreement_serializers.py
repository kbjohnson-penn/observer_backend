...
class AgreementSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Agreement
        fields = [
            'id', 'agreement_type', 'title', 'version', 
            'content', 'document_url', 'project_name', 
...
class UserAgreementListSerializer(serializers.ModelSerializer):
    ...
    project_description = serializers.CharField(source='agreement.project_description', read_only=True)
    ...
    class Meta:
        model = UserAgreement
        fields = [
            'id', 'agreement_title', 'agreement_version', 
            'agreement_type', 'project_name', 'project_description',
            'document_url', 'date_signed', 'is_active'
        ]