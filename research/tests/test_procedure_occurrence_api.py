...
class ProcedureOccurrenceAPITest(BaseResearchAPITestCase):
    ...
    def test_get_procedures_authenticated(self):
        ...
        response = self.client.get('/api/v1/private/procedure-occurrences/')
    ...
    def test_get_procedure_detail_authenticated(self):
        ...
        response = self.client.get(f'/api/v1/private/procedure-occurrences/{self.procedure_occurrence.id}/')
    ...
    def test_get_procedure_detail_not_found(self):
        ...
        self.authenticate_user()
        response = self.client.get('/api/v1/private/procedure-occurrences/99999/')
