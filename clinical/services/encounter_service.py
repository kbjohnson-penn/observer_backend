...
from clinical.models import EncounterSource, MultiModalData, Patient, Provider
...
class EncounterService:
    ...
    def _ensure_timezone_aware_datetime(cls, encounter):
        ...
        if encounter.encounter_date_and_time and timezone.is_naive(
    ...
    def _create_simcenter_provider(cls):
        ...
        highest_provider = (
            Provider.objects.using("clinical")
            .filter(
