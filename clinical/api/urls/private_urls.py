...
router.register(r"encountersources", EncounterSourceViewSet, basename="v1-encountersource")
...
router.register(r"encounterfiles", EncounterFileViewSet, basename="v1-encounterfile")
