from clinical.models import Patient, Provider, Department, MultiModalData, Encounter, EncounterSource
from clinical.api.serializers import (
    PublicPatientSerializer, PublicProviderSerializer, PublicEncounterSerializer, 
    PublicDepartmentSerializer, MultiModalDataSerializer, PublicEncounterSourceSerializer
)
...
class PublicEncounterViewSet(BasePublicReadOnlyViewSet):
    ...
    def get_queryset(self):
        ...
        return Encounter.objects.using('clinical').select_related(
