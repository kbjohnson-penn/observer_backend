...
def validate_field(value):
    if not re.fullmatch(r"^[A-Za-zÀ-ÖØ-öø-ÿ'’\-\s\.]+$", value):
        raise ValidationError('This field can only contain letters (including accented characters), apostrophes, hyphens, spaces, and periods.')
...
def validate_website(value):
    if not re.fullmatch(r'^[A-Za-z0-9][A-Za-z0-9\-.][A-Za-z0-9\-._~:/?#[\]@!$&\'()*+,;=]*$', value):
        raise ValidationError('Website can only contain letters, numbers, and URL-safe characters.')
